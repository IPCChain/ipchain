...
BOOST_AUTO_TEST_CASE(ipc_mutiple_normalTx)
{
	...
	////两个输入一个输出。输入在同一个txid中且为同一个序列号，表示这是两个从同一个UTXO来的交易，应该报错
	////该部分原来是在Validation里处理的，所以不再在createrawtransaction中处理
	//prevout =
	//	"[{\"txid\":\"b4cc287e58f87cdae59417329f710f3ecd75a4ee1d2872b7248f50977c8493f3\","
	//	"\"vout\":1,\"scriptPubKey\":\"a914b10c9df5f7edf436c697f02f1efdba4cf399615187\","
	//	"\"redeemScript\":\"512103debedc17b3df2badbcdd86d5feb4562b86fe182e5998abd8bcd4f122c6155b1b21027e940bb73ab8732bfdf7f9216ecefca5b94d6df834e77e108f68e66f126044c052ae\"},"
	...
	//	"[{\"txtype\":0,\"address\":\"3HqAe9LtNBjnsfM4CyYaWTnvCaUYT7v4oZ\",\"value\":11}]"), std::runtime_error);
...
BOOST_AUTO_TEST_CASE(ipc_ipTx)
{
	...
	//交易type=2，扩展交易类型为0，起始结束时间为0，再授权为1，排他性为0，知产标题为title，hash值任意（注：HASH输出为反序，因为是小端）
	prevout =
		"[{\"txid\":\"b4cc287e58f87cdae59417329f710f3ecd75a4ee1d2872b7248f50977c8493f3\","
		"\"vout\":1,\"scriptPubKey\":\"a914b10c9df5f7edf436c697f02f1efdba4cf399615187\","
		"\"redeemScript\":\"512103debedc17b3df2badbcdd86d5feb4562b86fe182e5998abd8bcd4f122c6155b1b21027e940bb73ab8732bfdf7f9216ecefca5b94d6df834e77e108f68e66f126044c052ae\"}]";
	...
	//所有权交易类型签名，交易type=2，扩展交易类型为0，起始结束时间为0，再授权为1，排他性为0，知产标题为testtitle，hash值任意（注：HASH输出为反序，因为是小端）
	prevout =
		"[{\"txid\":\"b4cc287e58f87cdae59417329f710f3ecd75a4ee1d2872b7248f50977c8493f3\","
		"\"vout\":1,\"scriptPubKey\":\"a914b10c9df5f7edf436c697f02f1efdba4cf399615187\","
		"\"redeemScript\":\"512103debedc17b3df2badbcdd86d5feb4562b86fe182e5998abd8bcd4f122c6155b1b21027e940bb73ab8732bfdf7f9216ecefca5b94d6df834e77e108f68e66f126044c052ae\"}]";
	...
	//交易type=2，扩展交易类型为0，起始结束时间为0，再授权为1，排他性为0，知产标题为testtitle，hash值任意（注：HASH输出为反序，因为是小端）
	prevout =
		"[{\"txid\":\"b4cc287e58f87cdae59417329f710f3ecd75a4ee1d2872b7248f50977c8493f3\","
		"\"vout\":1,\"scriptPubKey\":\"a914b10c9df5f7edf436c697f02f1efdba4cf399615187\","
		"\"redeemScript\":\"512103debedc17b3df2badbcdd86d5feb4562b86fe182e5998abd8bcd4f122c6155b1b21027e940bb73ab8732bfdf7f9216ecefca5b94d6df834e77e108f68e66f126044c052ae\"}]";
	...
	//交易type=3，扩展交易类型为0，起始结束时间为0，再授权为1，排他性为0，知产标题为title，hash值任意（注：HASH输出为反序，因为是小端）
	prevout =
		"[{\"txid\":\"b4cc287e58f87cdae59417329f710f3ecd75a4ee1d2872b7248f50977c8493f3\","
		"\"vout\":1,\"scriptPubKey\":\"a914b10c9df5f7edf436c697f02f1efdba4cf399615187\","
		"\"redeemScript\":\"512103debedc17b3df2badbcdd86d5feb4562b86fe182e5998abd8bcd4f122c6155b1b21027e940bb73ab8732bfdf7f9216ecefca5b94d6df834e77e108f68e66f126044c052ae\"}]";
	...
	//授权交易类型签名，交易type=3，扩展交易类型为1，起始结束时间为0，再授权为0，排他性为1，知产标题为title，hash值任意（注：HASH输出为反序，因为是小端）
	prevout =
		"[{\"txid\":\"b4cc287e58f87cdae59417329f710f3ecd75a4ee1d2872b7248f50977c8493f3\","
		"\"vout\":1,\"scriptPubKey\":\"a914b10c9df5f7edf436c697f02f1efdba4cf399615187\","
		"\"redeemScript\":\"512103debedc17b3df2badbcdd86d5feb4562b86fe182e5998abd8bcd4f122c6155b1b21027e940bb73ab8732bfdf7f9216ecefca5b94d6df834e77e108f68e66f126044c052ae\"}]";
...
BOOST_AUTO_TEST_CASE(ipc_mutiple_ipTx)
{
	...
	//纯输出类型组合验证（不包括对输入的条件判定，不考虑混合交易，即默认为同一知产标题和知产hash值）
	
	//输出所有权类型，输出中有超过一个以上的所有权类型，报错
	prevout =
		"[{\"txid\":\"b4cc287e58f87cdae59417329f710f3ecd75a4ee1d2872b7248f50977c8493f3\","
		"\"vout\":1,\"scriptPubKey\":\"a914b10c9df5f7edf436c697f02f1efdba4cf399615187\","
		"\"redeemScript\":\"512103debedc17b3df2badbcdd86d5feb4562b86fe182e5998abd8bcd4f122c6155b1b21027e940bb73ab8732bfdf7f9216ecefca5b94d6df834e77e108f68e66f126044c052ae\"}]";
	...
	//输出授权类型为排他性授权时，其它输出中存在授权类型，报错

	//输出授权类型为排他性授权时，其他输出中不存在所有权类型，报错
...
BOOST_AUTO_TEST_CASE(ipc_devoteTx)
{
	...
	//竞选交易类型签名，交易type=1，贡献度=0x12345678
	r = CallRPC(std::string("signrawtransaction ") + lastresult + " " + prevout + " " + "[]");
	BOOST_CHECK(find_value(r.get_obj(), "complete").get_bool() == false);
...
BOOST_AUTO_TEST_CASE(ipc_tokenreg)
{
	...
	BOOST_CHECK_THROW(CallRPC(std::string("createrawtransaction ") + prevout + " " +
		"[{\"txtype\":\"4\","
		"\"TokenSymbol\":305419896,"//0x12345678
		"\"TokenHash\":\"f393847c97508f24b772281deea475cd\","
		"\"TokenLabel\":\"TestTokenLabel\","
		"\"TokenIssue\":1501818090," //代币发行时间戳
		"\"TokenTotalCount\":100000," //代币发行总量，共10W枚。登记时此值一同写入代币数量字段
	...
	BOOST_CHECK_NO_THROW(CallRPC(std::string("createrawtransaction ") + prevout + " " +
		"[{\"txtype\":4,"
		"\"TokenSymbol\":\"abcdefgh\","//0x12345678
		"\"TokenHash\":\"f393847c97508f24b772281deea475cd\","
		"\"TokenLabel\":\"TestTokenLabel\","
		"\"TokenIssue\":1501818090," //代币发行时间戳
		"\"TokenTotalCount\":100000," //代币发行总量，共10W枚。登记时此值一同写入代币数量字段
	...
	BOOST_CHECK_THROW(CallRPC(std::string("createrawtransaction ") + prevout + " " +
		...
		"\"TokenLabel\":\"0000\","
		"\"TokenIssue\":1501818090," //代币发行时间戳
		"\"TokenTotalCount\":100000w," //代币发行总量，共10W枚。登记时此值一同写入代币数量字段
		"\"address\":\"3HqAe9LtNBjnsfM4CyYaWTnvCaUYT7v4oZ\","
		"\"value\":12}]"), std::runtime_error);

	//Symbol字段中不允许出现各种大小写ipc字样
	prevout =
		"[{\"txid\":\"dddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddd\","
		"\"vout\":1,\"scriptPubKey\":\"a914b10c9df5f7edf436c697f02f1efdba4cf399615187\","
		"\"redeemScript\":\"512103debedc17b3df2badbcdd86d5feb4562b86fe182e5998abd8bcd4f122c6155b1b21027e940bb73ab8732bfdf7f9216ecefca5b94d6df834e77e108f68e66f126044c052ae\"}]";
	BOOST_CHECK_THROW(CallRPC(std::string("createrawtransaction ") + prevout + " " +
		"[{\"txtype\":4,"
		"\"TokenSymbol\":\"34ipCdd\","//0x12345678
		"\"TokenHash\":\"f393847c97508f24b772281deea475cd\","
		"\"TokenLabel\":\"0000\","
		"\"TokenIssue\":1501818090," //代币发行时间戳
		"\"TokenTotalCount\":100000," //代币发行总量，共10W枚。登记时此值一同写入代币数量字段
	...
	BOOST_CHECK_THROW(CallRPC(std::string("createrawtransaction ") + prevout + " " +
		"[{\"txtype\":4,"
		"\"TokenSymbol\":\"bbcabcde\","//0x12345678
		"\"TokenHash\":\"f393847c97508f24b772281deea475cd\","
		"\"TokenLabel\":\"32aipcpc\","
		"\"TokenIssue\":1501818090," //代币发行时间戳
		"\"TokenTotalCount\":100000," //代币发行总量，共10W枚。登记时此值一同写入代币数量字段
	...
	BOOST_CHECK_THROW(CallRPC(std::string("createrawtransaction ") + prevout + " " +
		"[{\"txtype\":4,"
		"\"TokenSymbol\":\"bbcabcdef\","//0x12345678
		"\"TokenHash\":\"f393847c97508f24b772281deea475cd\","
		"\"TokenLabel\":\"32aIpcpc\","
		"\"TokenIssue\":1501818090," //代币发行时间戳
		"\"TokenTotalCount\":100000," //代币发行总量，共10W枚。登记时此值一同写入代币数量字段
...
BOOST_AUTO_TEST_CASE(ipc_TxSend)
{
	...
	////正常发送会怎样？
	//BOOST_CHECK_NO_THROW(r = CallRPC(std::string("sendrawtransaction ") + ""));
	//BOOST_CHECK_EQUAL(r.write(), "");
}
