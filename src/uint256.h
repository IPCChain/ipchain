...
public:
	...
	inline int NumberCompare(const base_blob& other) const {
		int cursize = sizeof(data);
		int othersize = sizeof(other.data);
...
* opaque blob of 256 bits and has no integer operations. Use arith_uint128 if
* those are required.
*/
