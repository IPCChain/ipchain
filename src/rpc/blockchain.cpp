...
UniValue blockheaderToJSON(const CBlockIndex* blockindex)
{
	...
	result.push_back(Pair("nPeriodCount", (int)blockindex->nPeriodCount));
	result.push_back(Pair("nPeriodStartTime", (uint64_t)blockindex->nPeriodStartTime));
	result.push_back(Pair("nTimePeriod", (int)blockindex->nTimePeriod));
...
UniValue blockToJSON(const CBlock& block, const CBlockIndex* blockindex, bool txDetails = false)
{
	...
	//result.push_back(Pair("totalfee", ValueFromAmount(totalfee)));
	//
