...
// static std::multimap<std::string,TranTinfo> mapmarkAdd;
//static std::multimap<std::string,CAmount> mapmarkAdd;
...
//int getstrStatus();;
   ...
   // static int FormatTxStatus(const CWalletTx& wtx);
...
//static bool getLastMark();
//static void setLastMark(bool ismarked);
