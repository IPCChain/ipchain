...
void ModalOverlay::tipUpdate(int count, const QDateTime& blockDate, double nVerificationProgress)
{
    ...
    printf("king1 blockProcessTime.size() %d \n",blockProcessTime.size());
 ...
 QString tmp=blockDate.date().toString("yyyy-MM-dd hh:mm:ss");
    ...
    if (!bestHeaderDate.isValid())
        return;
    printf("king 2 bestheaderdata is not valid \n");
    ...
    printf("king 3 estimateNumHeadersLeft  %d \n",estimateNumHeadersLeft);
