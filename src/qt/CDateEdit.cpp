    ...
    : QDialog(parent)
{
    ...
    m_calendarWidget->setVerticalHeaderFormat(QCalendarWidget::NoVerticalHeader);//no week header
...
void CCalendarWidget::setMinimumDate(QDate &date){
    m_calendarWidget->setMinimumDate(date);
}
...
void CDateEdit::setMinimumDate(QDate &date)
{
    m_calendarWidget->setMinimumDate(date);
}
