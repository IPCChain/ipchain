...
public:
    ...
    //20170908QString add1,uint64_t amount1,
...
//SendCoinsReturn prepareeCoinsCreateTransaction(QStringList label,QString add1,CAmount amount1,WalletModelTransaction &transaction, const CCoinControl *coinControl);
    ...
    //ipclist
    std::vector<COutput> m_ipcCoins;//20181001
