    ...
    ui(new Ui::setdialog)
{
    ...
    //connect(exportdialogPage,SIGNAL(back()),this,SLOT(gotoWalletViewPage()));

    SetRecoveryPage = new SetRecovery(this);
    //connect(SetRecoveryPage,SIGNAL(back()),this,SLOT(gotoWalletViewPage()));
...
void setdialog::setModel(WalletModel *_model)
{
    ...
    //SetMessageAuthenticationPage->setModel(model);
...
void setdialog::setAddeditpageshow( editadddialog   *editaddpage)
{
    walletStackBranchPage->addWidget(editaddpage);
    walletStackBranchPage->setCurrentWidget(editaddpage);
}

void setdialog::backAddpageshow(AddBookWidget *Addbookpage)
{
...
void setdialog::gotoMessageAuthenticationPageSlot()
{
    ...
    //  walletStackBranchPage->setCurrentWidget(SetMessageAuthenticationPage);
}
