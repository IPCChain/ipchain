...
public:
   ...
   // void showchaininfo(int count, const QDateTime& blockDate, double nVerificationProgress, bool header);
    /*
...
private:
    ...
    sendhistory* sendpage;

    RecvHistory* recvpage;

    sendipchistory* sendipcpage;

    recvipchistory* recvipcpage;

    SendTokenHistory*  sendtokenpage ;
    RecvTokenHistory*   recvtokenpage;
