...
#include "addressbookpage.h"//20170807
...
void SendCoinsDialog::setModel(WalletModel *_model)
{
    ...
    connect(_model, SIGNAL(balanceChanged(CAmount,CAmount,CAmount,CAmount,CAmount,CAmount)), this, SLOT(setBalance(CAmount,CAmount,CAmount,CAmount,CAmount,CAmount)),Qt::QueuedConnection);
}
...
{
    Q_EMIT openAddBookPagewidget(model->getAddressTableModel(),2);//20170808  fuckmodel
