...
主机：CPU（双核2.5G+）  2G+ Memory   100G+ Harddisk\r\n\
网络：20M+ bps\r\n\
运行条件：（MTBF > 100000 小时）\r\n\
...
记账保证金(测试网络)\r\n\
    ...
    71~100	420 IPC\r\n\
    >100	680 IPC\r\n\
    （记账保证金为测试网络测试规则，正式网络规则待正式链上线后确认）\r\n\
    \r\n\
3、记账奖励\r\n\
        记账奖励按照如下规则执行：\r\n\
...
\r\n\
        ...
        （1）To participate in the accounting, first need to have the following hardware requirements:\r\n\
          —— Host: CPU (dual-core) 2.5G+/ Memory 2G + / Harddisk 100G +\r\n\
          —— Network: 20M + bps\r\n\
...
\r\n\
        Bookkeeping number	Deposit\r\n\
                ...
                >100	680 IPC\r\n\
\r\n\
             （Billing margin test network test rules, the formal network rules to be confirmed after the formal chain）\r\n\
\r\n\
        3.2 Book rewards：\r\n\
