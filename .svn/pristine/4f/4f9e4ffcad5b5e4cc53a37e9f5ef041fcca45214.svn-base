...
void unionaccountcreate::on_createBtn_pressed()
{
    ...
    if(add1_ !="")
    {
          LOG_WRITE(LOG_INFO,"num1");
        vec_add.push_back(add1_);
        LOG_WRITE(LOG_INFO,"num12");
        if(model->isMyPk(add1_)){
            LOG_WRITE(LOG_INFO,"num13");
            mypknum++;
        }
    }
    ...
    if(model->CreateUnionAddress(conf_num,vec_add,union_script,union_add,m_failreason))
    {
        ...
        else
        {
            ...
            else
            {
                ...
                ui->label_error->setText(tr("join error"));
            }
    ...
    else
    {
        ...
        {
            LOG_WRITE(LOG_INFO,"CREATE FAIL");
            ui->label_error->setText(tr("create error"));
        }
    }
}
